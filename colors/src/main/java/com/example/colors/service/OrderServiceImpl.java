    ...
    public Orders SaveOrder() {
       ...
       String color2 = s.nextLine();
        if(!StringUtils.isEmpty(color2)){
            ...
            //The below lines are not required at all #Ravi review, we are fetching same data twice...
            //Optional<Colors> colors1 = colorsRepository.findById((long)searchResult.get(0).getColorId());
